...
def test_config_loading():
    ...
    try:
        ...
        config = Config.from_file("config.yaml.example")
...
def test_message_processing():
    ...
    try:
        ...
        # Create gateway app
        app = GatewayApp("config.yaml.example")
        app.config = config
...
def test_caltopo_url_building():
    ...
    try:
        ...
        expected = "https://caltopo.com/api/v1/position/report/MESH-TEAM-ALPHA?id=TEST-DEVICE&lat=61.218846&lng=-149.900132"
