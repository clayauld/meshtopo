...
- feat: Enable environment variable overrides for MQTT and CalTopo configurations and add extensive CalTopo reporter tests. ([`e95a751`](https://github.com/clayauld/meshtopo/commit/e95a751))
- feat: Introduce simplified Docker Compose deployment options and integrated MQTT setup with updated documentation and configuration examples. ([`d719726`](https://github.com/clayauld/meshtopo/commit/d719726))
- feat: Mount `config.yaml` to mosquitto and update its healthcheck to use MQTT credentials from the config file. ([`d9881af`](https://github.com/clayauld/meshtopo/commit/d9881af))

### Refactor

- refactor: Replace Caddy with Traefik for improved MQTT TCP/SSL support. ([`7b9d57c`](https://github.com/clayauld/meshtopo/commit/7b9d57c))
- refactor: Use explicit environment variables for Mosquitto MQTT credentials and simplify its healthcheck command in docker-compose. ([`7e8485a`](https://github.com/clayauld/meshtopo/commit/7e8485a))
- refactor: Replace `sqlitedict` with custom `PersistentDict` for secure, in-house persistent storage. ([`83ed3b8`](https://github.com/clayauld/meshtopo/commit/83ed3b8))
- refactor: Add tablename validation and `nosec` comments to `PersistentDict` SQL queries. ([`d77c815`](https://github.com/clayauld/meshtopo/commit/d77c815))

### Chore

- chore(deps): Bump aiomqtt from 2.1.0 to 2.4.0 ([`0a2c15d`](https://github.com/clayauld/meshtopo/commit/0a2c15d))
- chore(deps): Bump pydantic from 2.12.3 to 2.12.5 ([`7a128e4`](https://github.com/clayauld/meshtopo/commit/7a128e4))
- chore(deps): Bump httpx from 0.24.1 to 0.28.1 ([`6a30738`](https://github.com/clayauld/meshtopo/commit/6a30738))
- chore(deps): Bump requests from 2.32.4 to 2.32.5 ([`1e9c35e`](https://github.com/clayauld/meshtopo/commit/1e9c35e))
- chore: Update README.md ([`a5cafd0`](https://github.com/clayauld/meshtopo/commit/a5cafd0))

## v0.1.0 (2025-12-21)

### Chore

- chore: remove unused imports from `test_coverage_edge_cases.py` . ([`b724d0c`](https://github.com/clayauld/meshtopo/commit/b724d0c5b6e7538ec8db5acef3a9624dbcd86a99))

- chore: Configure integration test environment, update CI workflow actions, refine pre-commit hooks, and remove deprecated files. ([`f0539ef`](https://github.com/clayauld/meshtopo/commit/f0539ef6ed94139e34e7d824031ad8a355db3a71))
...
- chore: Remove all issue tracking data and apply minor formatting and readability improvements to tests. ([`35281c9`](https://github.com/clayauld/meshtopo/commit/35281c9867801250cecb2c24a524f126c41e55b1))
...
- chore: Update CI configuration to use string format for Python versions, add debug step for Python version, and enable pip caching ([`0dc7707`](https://github.com/clayauld/meshtopo/commit/0dc77071e97083df52106060278514b135a8eca8))

- chore: Update documentation links and clean up formatting in README, adjust service documentation URL, and remove Docker Compose version from configuration ([`2d0f17e`](https://github.com/clayauld/meshtopo/commit/2d0f17e6059499effe91d6ef9a64a1664b9d7003))

### Documentation

- docs: Reformat review documents, add new review, and update configuration and core logic files.

Fix bug where old position updates would retransmit on startup. ([`a87ba63`](https://github.com/clayauld/meshtopo/commit/a87ba6349f6b3e51e6a77d74bb5e467ef8557ea1))

- docs: Update security audit report, add map updates bug review, and address security vulnerabilities in gateway app and docker-compose. ([`269c713`](https://github.com/clayauld/meshtopo/commit/269c713036716a083a8a0bc6787a62f7c6151383))

- docs: Consolidate and update review documentation, replacing old review files with new ones and adding new security findings. ([`6b45bd8`](https://github.com/clayauld/meshtopo/commit/6b45bd8c614c5e155d8362036ef01fdbfab864bc))

- docs: Add code review documents detailing security audit findings, dependency management consolidation, and various code quality improvements. ([`84ecaa3`](https://github.com/clayauld/meshtopo/commit/84ecaa33ba85c984a3f4f6085de139307e67fe65))

- docs: Update engineering review status for Dockerfile layer caching and adjust table formatting. ([`ed64af3`](https://github.com/clayauld/meshtopo/commit/ed64af37f7500089e32a79a465dde36d2c26f23b))

### Feature

- feat: Update GitHub Actions versions, add Docker Compose deployment backup, and remove old password file. ([`19c5b07`](https://github.com/clayauld/meshtopo/commit/19c5b07ef7810ae06e482968a25a060184a060bb))

- feat: Implement shared HTTP client, optimize debug logging, improve SqliteDict decoding, and update docker-compose for Traefik/Mosquitto with password file removal. ([`7dd66ae`](https://github.com/clayauld/meshtopo/commit/7dd66aea5b7d311bd07a6b31a03bae9286bcdd59))

- feat: Migrate SSL/reverse proxy from Traefik to Caddy, updating deployment configurations and removing old authentication files. ([`ca04204`](https://github.com/clayauld/meshtopo/commit/ca0420403bdd6056a660b5186f2d76608a453a95))

- feat(security): prevent log injection by sanitizing untrusted inputs
...
Added `tests/test_utils.py` to verify sanitization logic. ([`3c98ba9`](https://github.com/clayauld/meshtopo/commit/3c98ba914de2a81f189a7f9ea95d3a3699876aa0))

- feat: secure passwords with SecretStr and sanitize MQTT logs ([`2246e3f`](https://github.com/clayauld/meshtopo/commit/2246e3f5650afb03b64f135109465afc64585008))

- feat: Add new tests for gateway and config, and update review documents. ([`39c06e5`](https://github.com/clayauld/meshtopo/commit/39c06e57dfe6b46ab43f2b3f9b96eddaca2711fa))

- feat: Migrate integration test environment variables to an `.env.integration` file, update CI to manage Docker Compose-based integration tests, and add `.env.*` to `.gitignore`. ([`5b673e5`](https://github.com/clayauld/meshtopo/commit/5b673e58ad50b5282b13763e3be83ad9f0fc29b4))

- feat: Implement automated pre-commit hook updates via GitHub Actions and add new engineering review documents. ([`909d112`](https://github.com/clayauld/meshtopo/commit/909d112d72dd45b16c262b81831a38edcc8b05e2))

- feat: Consolidate dependency management to pyproject.toml, add code coverage to tests, and enhance CalTopo URL validation with pattern-based whitelisting. ([`4e6902e`](https://github.com/clayauld/meshtopo/commit/4e6902e27d5707f119a66bcd6ee44288e8806629))

- feat: enhance integration tests with service health checks, update MQTT client API, and add project documentation. ([`aff9fe3`](https://github.com/clayauld/meshtopo/commit/aff9fe3a180ca88d04d8e9eca91fcd7494932b1b))

- feat: Add integration test suite with Docker Compose, mock server, and CI/CD workflows, and update project dependencies and configurations. ([`d0791b7`](https://github.com/clayauld/meshtopo/commit/d0791b7ac65bea8aa1c564f31c4fc5a07e887967))

- feat: Add new dependencies including `click-option-group`, `gitpython`, `markdown-it-py`, and development tools `black`, `isort`, `mypy`, `pre-commit`, `pytest`. ([`2324a5d`](https://github.com/clayauld/meshtopo/commit/2324a5de20b98a7526906face02206052afe5985))

- feat: Update dependencies, add release workflow, and refine core application logic. ([`f65bd4c`](https://github.com/clayauld/meshtopo/commit/f65bd4cbb704e327d5267aeaba2e2510991ca5bc))

- feat: Add CalTopo reporter tests, update pre-commit hooks with security scanning, and introduce PR analysis workflow. ([`b7ad50f`](https://github.com/clayauld/meshtopo/commit/b7ad50f292c22abba232e4ce0bc63d4e8bbc0143))

- feat: Atomically create Mosquitto password file using a temporary file, enhancing robustness and error handling during user password setup. ([`dbce6f7`](https://github.com/clayauld/meshtopo/commit/dbce6f7de18847d34a8c8433c9a5c96819192318))
...
- fix: Correct MQTT node attribution by deterministically converting numeric IDs, improve config node ID lookup robustness. ([`c56f483`](https://github.com/clayauld/meshtopo/commit/c56f4838fb925138ac7153da3dfa6887854c37a8))

- fix: prioritize configured node names over database entries for callsign resolution, add a reproduction script, and update docker-compose configurations. ([`59a70b5`](https://github.com/clayauld/meshtopo/commit/59a70b5e6d264d74bc0bcf974720f1e99f1d6c1a))

- fix: Address security vulnerabilities identified in the audit report and update review documents. ([`1973826`](https://github.com/clayauld/meshtopo/commit/1973826e08767a2afeea3c60238a3217beda47f6))

- fix: Resolve log injection vulnerability, refactor callsign resolution logic, and improve `sys.path` handling. ([`8f2a7e0`](https://github.com/clayauld/meshtopo/commit/8f2a7e0a91f2d0f54a217648b89c23841d84eaf6))

- fix: Update integration tests and CI to use `docker compose logs` and document resolution of SSRF and hardcoded container name issues in review files. ([`8385b7a`](https://github.com/clayauld/meshtopo/commit/8385b7a6d23aa87dd6ff71182848c61c9e3874b7))

- fix: Validate MQTT user entries are dictionaries to prevent processing non-dict types. ([`e95c4fb`](https://github.com/clayauld/meshtopo/commit/e95c4fb4952b9c7e9e47d668270a2f654de04cce))
...
- fix: fix linting issues ([`1399968`](https://github.com/clayauld/meshtopo/commit/13999689c1c8f51aa1b377afc8fe02f72c25dcd5))
...
- refactor: Consolidate dependency management to `pyproject.toml` and add new review documents. ([`e1f7418`](https://github.com/clayauld/meshtopo/commit/e1f741863ef9bdaf011fa5ad2163152ec7bc4522))

- refactor: Initialize `SqliteDict` instances in `initialize()` and add checks for their availability before use. ([`3a10d93`](https://github.com/clayauld/meshtopo/commit/3a10d9323471fcd0006a2fc0fc8639fef132b446))

- refactor: Introduce `has_connect_key` and `has_group` properties in CalTopo config for clearer validation and usage. ([`36e3cd5`](https://github.com/clayauld/meshtopo/commit/36e3cd54ba37044f23e42906ba7fe0e9f6ad1c8c))

- refactor: migrate tests from unittest to pytest and remove recursive flag from bandit pre-commit hook. ([`eae8320`](https://github.com/clayauld/meshtopo/commit/eae8320ac1e97addad8674548c1c1e23d61b7a08))

- refactor: improve Mosquitto password file generation by pre-creating the temporary file and passing passwords via stdin. ([`006e25e`](https://github.com/clayauld/meshtopo/commit/006e25ebbd5efd6ca800a4c193809a630923e916))
...
- test: add `GatewayApp` and `CalTopoReporter` edge case tests . ([`26d66f6`](https://github.com/clayauld/meshtopo/commit/26d66f6d80137f95995aee14a99bfadd7710eaad))

### Unknown

- Merge pull request #40 from clayauld/enginerring-review-phase-2

Enginerring review phase 2 and 3 ([`1e95029`](https://github.com/clayauld/meshtopo/commit/1e95029cc1de27dd0a6ef0013701ddacb3c830e7))

- fix bandit not found issue with gh-actions;. ([`c9996ba`](https://github.com/clayauld/meshtopo/commit/c9996baf42073fe7139ec7184528324662bbbfea))

- update editorconfig and linting settings with precommit ([`0e50a5e`](https://github.com/clayauld/meshtopo/commit/0e50a5e36087e68a9429a44fd859880df0eddcfe))

- Merge branch &#39;enginerring-review-phase-2&#39; of github.com:clayauld/meshtopo into enginerring-review-phase-2 ([`d6ad786`](https://github.com/clayauld/meshtopo/commit/d6ad7863fa23b5e7e6dc761e151f3942e0db3725))

- Potential fix for code scanning alert no. 12: Workflow does not contain permissions

Co-authored-by: Copilot Autofix powered by AI &lt;62310815+github-advanced-security[bot]@users.noreply.github.com&gt; ([`6733588`](https://github.com/clayauld/meshtopo/commit/6733588e1abf9c0429c8fa8e60f560a961ca233d))

- Potential fix for code scanning alert no. 13: Workflow does not contain permissions

Co-authored-by: Copilot Autofix powered by AI &lt;62310815+github-advanced-security[bot]@users.noreply.github.com&gt; ([`8cecdc2`](https://github.com/clayauld/meshtopo/commit/8cecdc249297d8a46a928400243858c028c6ee36))

- Merge pull request #28 from clayauld/engineering-review-phase-3

feat: Add integration test suite with Docker Compose, mock server, an… ([`4f7ad52`](https://github.com/clayauld/meshtopo/commit/4f7ad52fb7eece55f24646ed300f441825edeb07))

- Merge branch &#39;fix-review-issues-9009032868292962196&#39; into engineering-review-phase-3 ([`8be2e8c`](https://github.com/clayauld/meshtopo/commit/8be2e8cbdeabacfca2b74b6cbc7c0b346fc37a67))

- Merge branch &#39;sentinel/log-injection-fix-5377583932860684775&#39; of github.com:clayauld/meshtopo into engineering-review-phase-3 ([`c7c961e`](https://github.com/clayauld/meshtopo/commit/c7c961e79feb6f29ce41381db882c83139b58143))

- Merge branch &#39;bolt/concurrent-caltopo-requests-2060976240090784757&#39; of github.com:clayauld/meshtopo into engineering-review-phase-3 ([`b5ff8f8`](https://github.com/clayauld/meshtopo/commit/b5ff8f883006d0bafaf1fff172f62e4e58295c4a))

- Merge branch &#39;sentinel/secure-config-logging-7206840899772605349&#39; into engineering-review-phase-3 ([`8525544`](https://github.com/clayauld/meshtopo/commit/8525544f1e7977512417256b15ccde7ebd3a2292))

- Merge branch &#39;main&#39; of github.com:clayauld/meshtopo into engineering-review-phase-3 ([`31dc951`](https://github.com/clayauld/meshtopo/commit/31dc951a6f92e3989a270b313c575fa75889fa92))

- Merge pull request #37 from clayauld/dependabot/pip/pydantic-2.12.5

chore(deps): Bump pydantic from 2.12.3 to 2.12.5 ([`e8e3413`](https://github.com/clayauld/meshtopo/commit/e8e341312982f7bcf967ea7170d88eb21417b9c9))

- Merge pull request #34 from clayauld/dependabot/github_actions/actions/github-script-8

chore(deps): Bump actions/github-script from 7 to 8 ([`d50981e`](https://github.com/clayauld/meshtopo/commit/d50981ed6a953293a5ff02cbad4e7b02006132d7))

- Merge pull request #36 from clayauld/dependabot/github_actions/codecov/codecov-action-5

chore(deps): Bump codecov/codecov-action from 3 to 5 ([`729679d`](https://github.com/clayauld/meshtopo/commit/729679d09d9df6648067138931854ba181258e5b))

- Merge pull request #35 from clayauld/dependabot/github_actions/actions/cache-5

chore(deps): Bump actions/cache from 3 to 5 ([`bbc580c`](https://github.com/clayauld/meshtopo/commit/bbc580cbe84a4ae9d676ceb6993b3a9e67000e12))

- Merge pull request #32 from clayauld/bolt/parallel-caltopo-requests-11199410520547490960

⚡ Bolt: Parallelize CalTopo requests and optimize logging ([`74e2af7`](https://github.com/clayauld/meshtopo/commit/74e2af7cdc75479bdd2656607c21970c59da2eed))

- ⚡ Bolt: Parallelize CalTopo API requests

Updated `CalTopoReporter.send_position_update` and `test_connection` to use `asyncio.gather` for concurrent execution of requests to multiple configured endpoints. This reduces latency when multiple endpoints are used and prevents one slow endpoint from blocking others. ([`186cc59`](https://github.com/clayauld/meshtopo/commit/186cc594fd73bc49eca657b5d4c98254a1f334fa))
...
🛡️ Sentinel: [HIGH] Fix insecure deserialization in state persistence ([`4d13126`](https://github.com/clayauld/meshtopo/commit/4d1312607098f645bef2f8aee401831570943746))

- Merge pull request #31 from clayauld/bolt/reuse-http-client-9636123755331419839

⚡ Bolt: Reuse HTTP client in CalTopoReporter ([`55085ad`](https://github.com/clayauld/meshtopo/commit/55085adf72f758e19edb009b8c092ce0282bcba8))

- ⚡ Bolt: Reuse HTTP client in CalTopoReporter

Refactored CalTopoReporter to use a persistent httpx.AsyncClient to enable connection reuse, reducing overhead for frequent API calls. Updated GatewayApp to manage the reporter lifecycle. ([`2484722`](https://github.com/clayauld/meshtopo/commit/24847229ba6b6774452d68c5fc601c23ea3f3fd5))
...
- Address outstanding review issues and security vulnerabilities ([`fb3313b`](https://github.com/clayauld/meshtopo/commit/fb3313bbea55fc51ddd17f6eef4e92e509076cf9))

- fIncrease code coverage tests and update code review documents. ([`e79efa7`](https://github.com/clayauld/meshtopo/commit/e79efa7c31fcda8effc2f9a476823681f098ebd4))

- fix flake8 errors ([`ebaa35f`](https://github.com/clayauld/meshtopo/commit/ebaa35f45937e81128119b31e79afba550b2d518))

- Fix error where logs and database aren&#39;t stored in mapped location from docker-compose.yaml ([`17e254a`](https://github.com/clayauld/meshtopo/commit/17e254a587095898737a52de8c5157c04a346518))

- Update mosquitto password generation. ([`ca9840a`](https://github.com/clayauld/meshtopo/commit/ca9840abc80bb8627eed3e0298f5116d86899e29))

- Merge remote-tracking branch &#39;origin/main&#39; into enginerring-review-phase-2 ([`7227e99`](https://github.com/clayauld/meshtopo/commit/7227e999173273f5f8e3f8f2d2a583012e8b30f9))
...
commit 4905f1a4379eb06a1de2b2d1ae7642ab104b14af
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:53:27 2025 +0000
...
commit 10f1ff15590027caeb9caae96d901dc0faf59469
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:52:51 2025 +0000
...
commit 3674f88f89525168fcb3224cb4a41a2495b76c51
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:52:50 2025 +0000
...
commit 7e5e4316f3a2be4eb683eceefbb335b7574c8a6e
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:41:24 2025 +0000
...
commit b203eabbd117fbda63aaef3384a82a2259976275
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:41:06 2025 +0000
...
commit 4e394f8c19e6a96dc9e49fb3e3a4b8b6bd9e269b
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:41:06 2025 +0000
...
commit 30f31cf4f97cdda40f084720eada951360fa1485
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:41:03 2025 +0000
...
commit 6577bbee32c67fe9499005f8626719ff1e205379
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:40:59 2025 +0000
...
commit b7e9db4780776a156350d67ab55bf1b66b124b16
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:40:56 2025 +0000
...
commit 25d94646ef2d118570fdad8606568e7ca67bcee2
Author: dependabot[bot] &lt;49699333+dependabot[bot]@users.noreply.github.com&gt;
Date: Sun Dec 14 01:40:52 2025 +0000
    ...
    Signed-off-by: dependabot[bot] &lt;support@github.com&gt; ([`c11a363`](https://github.com/clayauld/meshtopo/commit/c11a363f54979457613e26abc59e35ec46108223))

- Merge pull request #25 from clayauld/dependabot/pip/pyyaml-6.0.3

chore(deps): Bump pyyaml from 6.0.1 to 6.0.3 ([`50a1f62`](https://github.com/clayauld/meshtopo/commit/50a1f6235c50f7ceff1898c7e83f26444a9d0511))

- Merge pull request #24 from clayauld/dependabot/pip/pytest-cov-7.0.0

chore(deps): Bump pytest-cov from 4.1.0 to 7.0.0 ([`669d11b`](https://github.com/clayauld/meshtopo/commit/669d11bba15843e1968262525898b540525faf4d))

- Merge pull request #23 from clayauld/dependabot/pip/paho-mqtt-2.1.0

chore(deps): Bump paho-mqtt from 1.6.1 to 2.1.0 ([`e36838b`](https://github.com/clayauld/meshtopo/commit/e36838bb5c795a46c90415a0a7e4b6f07ce67918))

- Merge pull request #26 from clayauld/dependabot/pip/pytest-8.4.2

chore(deps): Bump pytest from 7.4.4 to 8.4.2 ([`62795c2`](https://github.com/clayauld/meshtopo/commit/62795c27e5952298233b093de2ac322905dea966))

- Merge pull request #22 from clayauld/dependabot/pip/requests-2.32.5

chore(deps): Bump requests from 2.32.4 to 2.32.5 ([`ab0b7d3`](https://github.com/clayauld/meshtopo/commit/ab0b7d37f37369048ded2168b139bed5b215f867))

- Merge pull request #21 from clayauld/dependabot/github_actions/actions/upload-artifact-6

chore(deps): Bump actions/upload-artifact from 4 to 6 ([`8e582f3`](https://github.com/clayauld/meshtopo/commit/8e582f3b7a11c9559f0e77d5229284b9c12acf41))

- Merge pull request #20 from clayauld/dependabot/github_actions/actions/checkout-6

chore(deps): Bump actions/checkout from 4 to 6 ([`47e9773`](https://github.com/clayauld/meshtopo/commit/47e97738cf0779e48fa0d8a68405831ae9fb4c6a))

- Merge pull request #19 from clayauld/dependabot/github_actions/docker/build-push-action-6

chore(deps): Bump docker/build-push-action from 5 to 6 ([`4f8e8a3`](https://github.com/clayauld/meshtopo/commit/4f8e8a3b4979a87607acf84e950cc262acc7987c))

- Merge pull request #18 from clayauld/dependabot/github_actions/actions/setup-python-6

chore(deps): Bump actions/setup-python from 4 to 6 ([`5caa654`](https://github.com/clayauld/meshtopo/commit/5caa65490887508fa28de9db6ee3e6bd62236f04))

- Merge pull request #17 from clayauld/dependabot/github_actions/dorny/test-reporter-2

chore(deps): Bump dorny/test-reporter from 1 to 2 ([`6c51036`](https://github.com/clayauld/meshtopo/commit/6c5103636fc728e4f4eeec597fc7593e138d9f22))

- Merge pull request #14 from clayauld/phase-1-engineering-review

feat: Implement Phase 1 of Engineering Review ([`655e95f`](https://github.com/clayauld/meshtopo/commit/655e95f4c71445e4ffd736f33121bceb42a3ffbf))

- Update scripts/setup_wizard.py

Co-authored-by: gemini-code-assist[bot] &lt;176961590+gemini-code-assist[bot]@users.noreply.github.com&gt; ([`cbe02fe`](https://github.com/clayauld/meshtopo/commit/cbe02fedf2c00a664af7643cf5d604b712b40cd3))

- Merge pull request #16 from clayauld/ci-cd-updates

feat: Add CalTopo reporter tests, update pre-commit hooks with securi… ([`7024003`](https://github.com/clayauld/meshtopo/commit/7024003a0e6384993fb88b7a257c3967156677d1))

- Remove `types-WTForms` from mypy dependencies, change bandit output format to screen, and update pytest hook to filter files instead of always running. ([`dbedbd3`](https://github.com/clayauld/meshtopo/commit/dbedbd37e4017c399ad2e89854c390af84489ec9))

- Merge pull request #15 from clayauld/fix-pr-comments

Fixes issues from PR review ([`b482a4d`](https://github.com/clayauld/meshtopo/commit/b482a4dbdda246040aa945319803d16b332f97bc))
...
Harden caltopo reporter ([`c28ceef`](https://github.com/clayauld/meshtopo/commit/c28ceefcbba42261f3c5728e5472858e4308bcec))

- Refactor: Improve readability of URL construction in CalTopoReporter
...
Co-authored-by: gemini-code-assist[bot] &lt;176961590+gemini-code-assist[bot]@users.noreply.github.com&gt; ([`3ea6cac`](https://github.com/clayauld/meshtopo/commit/3ea6cac1dc9b059708c9e3de428bdc13334a604a))
...
Fix docker build file not found error ([`79aedf4`](https://github.com/clayauld/meshtopo/commit/79aedf4ea385940279b28349b3f7e80722a46a23))
...
Fix pytest module not found error ([`540f69e`](https://github.com/clayauld/meshtopo/commit/540f69e3a52849d4128adc47bb466a2019b591ed))
...
chore(deps): Bump jinja2 from 3.1.2 to 3.1.6 in the pip group across 1 directory ([`de67f52`](https://github.com/clayauld/meshtopo/commit/de67f5284e990b6a512377b2bf2c8c06262c1b66))

- Merge pull request #3 from clayauld/feature/web-api-full-system

Feature/web api full system ([`a6154af`](https://github.com/clayauld/meshtopo/commit/a6154af4664dac9bd116b15edba39892d886a186))
...
- Remove obsolete pre-commit.sh script

This script&#39;s functionality for exporting Beads issues has been migrated
to a self-contained local hook in .pre-commit-config.yaml (lines 104-117).
Removing the obsolete script to avoid confusion and keep the project clean.

Addresses Gemini Code Assist feedback. ([`3b79c15`](https://github.com/clayauld/meshtopo/commit/3b79c154bdf5db12f8fd0d76d89a440e84ee1e4d))

- Remove duplicate docker-compose-mqtt.yml file

This file was an exact duplicate of deploy/docker-compose.yml and was not referenced in the Makefile or any scripts. Removing it to avoid confusion and code duplication.

Addresses Gemini Code Assist feedback. ([`0148294`](https://github.com/clayauld/meshtopo/commit/01482948ac46f3de2e96b41038c87f016ab663fb))
...
Added a note about compliance checks before pushing changes. ([`e5aa597`](https://github.com/clayauld/meshtopo/commit/e5aa59752d42bf7fc9978e1b07f8ffb03d510164))
...
Co-authored-by: gemini-code-assist[bot] &lt;176961590+gemini-code-assist[bot]@users.noreply.github.com&gt; ([`c7c21e3`](https://github.com/clayauld/meshtopo/commit/c7c21e37bc29b9c3605cf1348c1a5ed0c1dcb088))
...
- Merge pull request #5 from clayauld/cursor/address-meshtopo-issues-sequentially-aec9

Address meshtopo issues sequentially ([`933f95a`](https://github.com/clayauld/meshtopo/commit/933f95a5166fd94a1a4eedf517780d794692436e))

- Update scripts/generate_mosquitto_config.py

Co-authored-by: gemini-code-assist[bot] &lt;176961590+gemini-code-assist[bot]@users.noreply.github.com&gt; ([`2dd43a9`](https://github.com/clayauld/meshtopo/commit/2dd43a98c17108a4aa86279891dbbc4fb419f6ff))
...
- Merge branch &#39;main&#39; of github.com:clayauld/meshtopo ([`e7f0ae9`](https://github.com/clayauld/meshtopo/commit/e7f0ae92e6e11e091d50377d09660e93344dee62))

- Merge pull request #2 from clayauld/dependabot/pip/requests-2.32.4

chore(deps): Bump requests from 2.31.0 to 2.32.4 ([`ec1d54e`](https://github.com/clayauld/meshtopo/commit/ec1d54e74e6e31f8e3bfb9d566a7fb04742e3828))

- Merge pull request #1 from clayauld/cursor/implement-system-from-design-document-a71c

Implement system from design document ([`00d953c`](https://github.com/clayauld/meshtopo/commit/00d953c32ac9d17ae2b4a9af1f1392ecce132d2d))
...
- Initial commit ([`fc6110c`](https://github.com/clayauld/meshtopo/commit/fc6110c03bc0ba58c694ab1cd7bfaac1d04bbff9))
