...
* [✔️] **[Low] Path Traversal Prevention**
  * *Location:* `src/caltopo_reporter.py`
...
* [✔️] **[Low] Secret Redaction in Logs**
  * *Location:* `src/caltopo_reporter.py`
...
* [✔️] **[Low] Log Injection Prevention**
...
1. **Permanent Callsign**: Updated logic to not persist temporary unknown mappings.
2. **Inconsistent State for Denied Devices**: Deferred persistence until after authorization.
3. **HTTP Client**: Refactored to use shared client.
4. **Disk I/O**: Implemented in-memory caching.
5. **Hardware ID Logic**: Extracted to helper method.
